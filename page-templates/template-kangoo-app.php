...
$default_apk_url = !empty($app_release['apk_url']) ? $app_release['apk_url'] : home_url('/app/android/kangoo-pouches-v0.6.1.apk');
$detected_app_version = !empty($app_release['version']) ? $app_release['version'] : '0.6.1';
...
$app_updated = $app_updated ?: 'June 2026';
