...
function kangoo_reviews_theme_render_card_summary($product_id) {
    ...
    if (empty($summary['count'])) {
        ...
        <span class="product-review-summary product-card__review-summary product-card__review-summary--empty" aria-label="<?php esc_attr_e('No reviews yet', 'kangoo'); ?>">
            <span class="kangoo-review-stars" aria-hidden="true">
                <span class="is-empty">&#9734;</span><span class="is-empty">&#9734;</span><span class="is-empty">&#9734;</span><span class="is-empty">&#9734;</span><span class="is-empty">&#9734;</span>
            </span>
        </span>
        <?php
        return;
