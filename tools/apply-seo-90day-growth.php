...
$categories = array(
    'nicotine-pouches' => array(
        ...
        'faq' => array(
            ...
            array('question' => 'Does Kangoo Pouches sell snus?', 'answer' => 'No. Kangoo Pouches sells tobacco-free nicotine pouches, not traditional tobacco snus.'),
        ),
		'seo_title' => 'Nicotine Pouches UK | Buy Online from 99p | Kangoo Pouches',
    ...
    '99p-pouches' => array(
        ...
        'intro' => 'Shop the established 99p nicotine pouch collection, with selected products temporarily reduced to 99p while promotional stock lasts.',
        'content' => '<h2>99p nicotine pouches with selected products now 99p</h2><p>This collection is Kangoo Pouches\'s permanent home for selected low-price nicotine pouches. The 99p price is a temporary promotion on qualifying products, not a replacement name for the collection and not a claim that every pouch on the site costs 99p.</p><h2>Check the product before ordering</h2><p>Promotional stock can include different brands, flavours and nicotine strengths. Compare the exact milligrams per pouch and any one-per-order restriction shown on the product card. A low promotional price does not make a high-strength pouch suitable for an inexperienced user.</p>' . $category_common,
        'faq' => array(
            ...
            array('question' => 'Is every nicotine pouch 99p?', 'answer' => 'No. The promotion applies only to selected products in this collection. Standard products and pack offers keep their own live prices.'),
            array('question' => 'Is there a purchase limit?', 'answer' => 'Some trial pouches are limited to one per order. The product card and basket show the current rule.'),
        ),
		'seo_title' => '99p Nicotine Pouches - Now from 99p | Kangoo Pouches',
        'seo_desc' => 'Shop 99p nicotine pouches with selected stocked products now 99p. Compare brands, flavours and strengths while promotional stock lasts. Adults 18+.',
...
foreach ($brand_data as $slug => $brand) {
    ...
    $categories[$slug] = array(
        ...
        'content' => '<h2>' . esc_html($name) . ' nicotine pouches in the UK</h2><p>Use this category to compare the ' . esc_html($name) . ' products Kangoo Pouches currently stocks. The range can include ' . esc_html($brand[1]) . ', with ' . esc_html($brand[2]) . '. Availability changes, so live product cards are the source for price and stock.</p>' . $category_common . '<h2>' . esc_html($name) . ' nicotine pouches, not tobacco snus</h2><p>Some shoppers use the word snus when searching for ' . esc_html($name) . '. Kangoo Pouches sells the tobacco-free nicotine pouch products shown here, not traditional tobacco snus.</p>',
        'faq' => array(
            ...
            array('question' => 'Does Kangoo Pouches sell ' . $name . ' snus?', 'answer' => 'Kangoo Pouches sells tobacco-free ' . $name . ' nicotine pouches, not traditional tobacco snus.'),
        ),
