...
$categories = array(
    'nicotine-pouches' => array(
        ...
        'faq' => array(
            ...
            array('question' => 'Are nicotine pouches the same as snus?', 'answer' => 'No. Nicotine pouches are tobacco-free. Traditional snus contains tobacco and is not what Kangoo Pouches sells.'),
		...
		'yoast_title' => 'Nicotine Pouches UK | Buy Online from 99p | Kangoo Pouches',
        'yoast_desc' => 'Buy nicotine pouches online in the UK from VELO, ZYN, Nordic Spirit, KILLA and more. Compare flavours, strengths and live prices from 99p.',
        'focus' => 'nicotine pouches UK',
    ),
    '99p-pouches' => array(
        'name' => '99p Nicotine Pouches',
        'heading' => '99p Nicotine Pouches - Now from 99p',
        'intro' => 'Shop the established 99p nicotine pouch collection, with selected stocked pouches temporarily reduced to 99p while promotional stock lasts.',
        'content' => '<h2>99p nicotine pouches</h2><p>This is Kangoo Pouches’ established 99p nicotine pouch collection. Selected trial pouches are available from 99p while allocated stock lasts. The collection name and URL remain centred on the searched 99p nicotine pouches term, while the live product price shows the current offer.</p><h2>What is included?</h2><p>The available selection can include products from brands such as ZYN, VELO, FUMi, Nordic Spirit and XQS. Stock changes, so only products shown as available can be purchased. Each trial pouch is limited to the quantity rules displayed on the product card or basket.</p><h2>Compare before you buy</h2><p>Check the brand, flavour and nicotine strength on every product. Trial pricing does not make a strong pouch suitable for a new user. Use the product page and filters to find the most appropriate option rather than choosing by price alone.</p><h2>Separate from normal pack pricing</h2><p>The 99p trial range is separate from standard single-tin and multi-buy pricing. Products outside this range keep their normal product and pack prices. Basket totals, stock controls and delivery thresholds continue to apply.</p><h2>Adults only</h2><p>Nicotine is addictive and every product is for adults aged 18 and over. Kangoo Pouches sells tobacco-free nicotine pouches, not traditional tobacco snus.</p>',
        'faq' => array(
            array('question' => 'Are these still 99p nicotine pouches?', 'answer' => 'Yes. This is the established 99p collection, with selected products temporarily reduced to 99p while promotional stock lasts.'),
            ...
            array('question' => 'Are all nicotine pouches 99p?', 'answer' => 'No. The 99p promotion applies only to selected products in this collection. Standard products and pack offers use their normal live prices.'),
        ),
		'yoast_title' => '99p Nicotine Pouches - Now from 99p | Kangoo Pouches',
        'yoast_desc' => 'Shop 99p nicotine pouches with selected stocked products now reduced to 99p. Compare brands, flavours and strengths while promotional stock lasts.',
...
foreach ($brand_specs as $slug => $spec) {
    ...
    $categories[$slug] = array(
        ...
        'faq' => array(
            ...
            array('question' => 'Does Kangoo Pouches sell ' . $brand . ' snus?', 'answer' => 'Kangoo Pouches sells tobacco-free ' . $brand . ' nicotine pouches, not traditional tobacco snus.'),
        ),
...
$articles = array(
    ...
    array(
        ...
        'content' => '<p>VELO and Nordic Spirit are two established tobacco-free nicotine pouch brands available to UK adults. The better choice depends on the flavour, strength and pouch format you prefer, not on a single universal winner.</p><h2>Range and availability</h2><p>VELO currently offers Kangoo Pouches shoppers a broader mix of cooling, fruit and citrus-led profiles. Nordic Spirit has a more focused range, often centred on mint and berry-style products. Live category pages are the reliable source because individual flavours can sell out or change.</p><h2>Flavour comparison</h2><p>VELO is useful if you want to compare peppermint, spearmint, berry, grape, tropical or citrus directions. Nordic Spirit may suit shoppers who prefer a smaller, familiar flavour set. Taste is subjective, so product descriptions should be treated as guidance rather than a guarantee.</p><h2>Strength and pouch feel</h2><p>Both brands offer products at different nicotine levels. Read the amount per pouch on the exact product page. Do not assume two tins with similar colours or names have the same strength. Adults with less nicotine experience should avoid jumping directly to a high-strength option.</p><h2>Price and pack options</h2><p>Kangoo Pouches shows the current single-tin price and available multi-buy tiers beside each product. Compare the total and per-tin value for the quantity you actually need. Promotional products are separate from normal pack pricing and may carry per-order limits.</p><h2>Which should you choose?</h2><p>Choose VELO when breadth of flavour and strength is the priority. Choose Nordic Spirit when one of its current mint or berry products closely matches your preference. If neither range fits, compare ZYN or another stocked brand rather than choosing only by logo.</p><h2>Important information</h2><p>Both ranges sold by Kangoo Pouches are tobacco-free nicotine pouches for adults aged 18 and over. Nicotine is addictive. They are not traditional tobacco snus.</p>',
    ),
    array(
        ...
        'content' => '<p>ZYN and Nordic Spirit both make tobacco-free nicotine pouches, but their current ranges differ in flavour breadth, format and strength. This comparison uses products actually stocked by Kangoo Pouches rather than pretending every international product is available in the UK.</p><h2>ZYN range</h2><p>ZYN products can include mini and regular formats with fruit, citrus, coffee and mint profiles. Mini pouches may appeal to adults who prefer a smaller pouch, but the product strength still needs to be checked individually.</p><h2>Nordic Spirit range</h2><p>Nordic Spirit offers a more concentrated selection on Kangoo Pouches, including fresh mint and berry-style choices when stocked. A smaller range can make comparison simpler, although it offers fewer flavour directions than ZYN.</p><h2>Strength comparison</h2><p>Brand name is not a strength guide. Compare the nicotine amount per pouch shown on the product page. If you are unsure, choose a lower level rather than assuming a stronger pouch provides better value.</p><h2>Price and availability</h2><p>Current prices, pack options and stock appear live on the relevant category and product pages. Selected trial pouches may be limited per order. Normal multi-buy prices remain separate.</p><h2>ZYN or Nordic Spirit?</h2><p>ZYN may suit shoppers who value a wider choice of flavour and format. Nordic Spirit may suit those who already know they prefer one of its mint or berry products. Both are adult-only, tobacco-free nicotine pouch ranges rather than traditional snus.</p>',
    ),
    array(
    ...
    array(
        ...
        'content' => '<p>VELO has one of the broader tobacco-free nicotine pouch ranges available through Kangoo Pouches. This review explains the differences shoppers can verify: flavour, nicotine strength, pouch format, pouch count, price and stock.</p><h2>VELO flavour range</h2><p>Depending on current availability, VELO flavours can include peppermint, spearmint, berry, grape, mango, lemon, orange and watermelon. Cooling mint products and sweeter fruit products provide distinctly different directions, so there is no single best VELO flavour for everyone.</p><h2>Strength options</h2><p>VELO products on Kangoo Pouches span lighter and stronger nicotine levels. Read the exact amount per pouch on each product. A flavour you enjoy is not a reason to select a strength above your experience.</p><h2>Format and pouch count</h2><p>Many VELO products use slim pouch formats, but the exact format and count should be confirmed on the individual product page. These details help make a fair price comparison between tins.</p><h2>Current prices and multi-buys</h2><p>Single-tin prices and pack tiers are shown live. Some VELO products also appear in the established 99p trial range when allocated stock is available. Trial limits and normal multi-buy ladders are separate.</p><h2>How VELO compares</h2><p>VELO generally offers broader flavour choice than Nordic Spirit in the current Kangoo Pouches catalogue. ZYN adds different mini and regular formats. Compare the categories directly if format matters as much as flavour.</p><h2>Verdict</h2><p>VELO is a strong range for adults who want to compare several flavour and strength combinations from one brand. The best choice is the product that matches your preferred flavour and suitable nicotine level. Nicotine is addictive and these products are for adults aged 18 and over.</p>',
    ),
);
...
if ($front_page_id > 0) {
    $home_title = 'Kangoo Pouches UK | Nicotine Pouches from 99p';
    $home_description = 'Shop nicotine pouches from VELO, ZYN, Nordic Spirit, KILLA and more. Compare flavours, strengths and live UK prices from 99p. Adults 18+ only.';
